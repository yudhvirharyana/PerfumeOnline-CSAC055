	...
	<div class="bgimage">
		<div class="menu">
		    ...
		    <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style11"> <strong>
                        <asp:Label ID="Label3" runat="server" CssClass="auto-style9" Text="Brand "></asp:Label>
                        </strong></td>
                    <td class="auto-style10">
                ...
                <tr>
                    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="246px" HorizontalAlign="Center" PageSize="20" Width="403px">
